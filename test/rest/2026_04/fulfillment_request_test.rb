...
class FulfillmentRequest202604Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2026-04/fulfillment_orders/1046000806/fulfillment_request.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "fulfillment_request" => hash_including({"message" => "Fulfill this ASAP please."}) }
      )
      .to_return(status: 200, body: JSON.generate({"original_fulfillment_order" => {"id" => 1046000806, "created_at" => "2025-07-02T11:35:26-05:00", "updated_at" => "2025-07-02T11:35:27-05:00", "shop_id" => 548380009, "order_id" => 450789469, "assigned_location_id" => 24826418, "request_status" => "submitted", "status" => "open", "fulfill_at" => nil, "fulfill_by" => nil, "supported_actions" => ["cancel_fulfillment_order"], "destination" => {"id" => 1042572138, "address1" => "Chestnut Street 92", "address2" => "", "city" => "Louisville", "company" => nil, "country" => "United States", "email" => "bob.norman@mail.example.com", "first_name" => "Bob", "last_name" => "Norman", "phone" => "+1(502)-459-2181", "province" => "Kentucky", "zip" => "40202"}, "origin" => {"address1" => nil, "address2" => nil, "city" => nil, "country_code" => "DE", "location_id" => 24826418, "name" => "Apple Api Shipwire", "phone" => nil, "province" => nil, "zip" => nil}, "line_items" => [{"id" => 1072503304, "shop_id" => 548380009, "fulfillment_order_id" => 1046000806, "quantity" => 1, "line_item_id" => 466157049, "inventory_item_id" => 39072856, "fulfillable_quantity" => 1, "variant_id" => 39072856}, {"id" => 1072503305, "shop_id" => 548380009, "fulfillment_order_id" => 1046000806, "quantity" => 1, "line_item_id" => 518995019, "inventory_item_id" => 49148385, "fulfillable_quantity" => 1, "variant_id" => 49148385}, {"id" => 1072503306, "shop_id" => 548380009, "fulfillment_order_id" => 1046000806, "quantity" => 1, "line_item_id" => 703073504, "inventory_item_id" => 457924702, "fulfillable_quantity" => 1, "variant_id" => 457924702}], "outgoing_requests" => [{"message" => "Fulfill this ASAP please.", "request_options" => {"notify_customer" => false}, "sent_at" => "2025-07-02T11:35:27-05:00", "kind" => "fulfillment_request"}], "international_duties" => nil, "fulfillment_holds" => [], "delivery_method" => {"id" => 989232621, "method_type" => "shipping", "min_delivery_date_time" => nil, "max_delivery_date_time" => nil, "additional_information" => {"phone" => nil, "instructions" => nil, "failed_carriers" => nil, "pickup_point_id" => nil}, "service_code" => nil, "detailed_branded_promise" => nil, "source_reference" => nil, "presented_name" => "Expedited Shipping"}}, "submitted_fulfillment_order" => {"id" => 1046000806, "created_at" => "2025-07-02T11:35:26-05:00", "updated_at" => "2025-07-02T11:35:27-05:00", "shop_id" => 548380009, "order_id" => 450789469, "assigned_location_id" => 24826418, "request_status" => "submitted", "status" => "open", "fulfill_at" => nil, "fulfill_by" => nil, "supported_actions" => ["cancel_fulfillment_order"], "destination" => {"id" => 1042572138, "address1" => "Chestnut Street 92", "address2" => "", "city" => "Louisville", "company" => nil, "country" => "United States", "email" => "bob.norman@mail.example.com", "first_name" => "Bob", "last_name" => "Norman", "phone" => "+1(502)-459-2181", "province" => "Kentucky", "zip" => "40202"}, "origin" => {"address1" => nil, "address2" => nil, "city" => nil, "country_code" => "DE", "location_id" => 24826418, "name" => "Apple Api Shipwire", "phone" => nil, "province" => nil, "zip" => nil}, "line_items" => [{"id" => 1072503304, "shop_id" => 548380009, "fulfillment_order_id" => 1046000806, "quantity" => 1, "line_item_id" => 466157049, "inventory_item_id" => 39072856, "fulfillable_quantity" => 1, "variant_id" => 39072856}, {"id" => 1072503305, "shop_id" => 548380009, "fulfillment_order_id" => 1046000806, "quantity" => 1, "line_item_id" => 518995019, "inventory_item_id" => 49148385, "fulfillable_quantity" => 1, "variant_id" => 49148385}, {"id" => 1072503306, "shop_id" => 548380009, "fulfillment_order_id" => 1046000806, "quantity" => 1, "line_item_id" => 703073504, "inventory_item_id" => 457924702, "fulfillable_quantity" => 1, "variant_id" => 457924702}], "outgoing_requests" => [{"message" => "Fulfill this ASAP please.", "request_options" => {"notify_customer" => false}, "sent_at" => "2025-07-02T11:35:27-05:00", "kind" => "fulfillment_request"}], "international_duties" => nil, "fulfillment_holds" => [], "delivery_method" => {"id" => 989232621, "method_type" => "shipping", "min_delivery_date_time" => nil, "max_delivery_date_time" => nil, "additional_information" => {"phone" => nil, "instructions" => nil, "failed_carriers" => nil, "pickup_point_id" => nil}, "service_code" => nil, "detailed_branded_promise" => nil, "source_reference" => nil, "presented_name" => "Expedited Shipping"}}, "unsubmitted_fulfillment_order" => nil}), headers: {})
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2026-04/fulfillment_orders/1046000806/fulfillment_request.json")
  ...
  def test_2()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2026-04/fulfillment_orders/1046000807/fulfillment_request.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
      ...
      .to_return(status: 200, body: JSON.generate({"original_fulfillment_order" => {"id" => 1046000807, "created_at" => "2025-07-02T11:35:27-05:00", "updated_at" => "2025-07-02T11:35:27-05:00", "shop_id" => 548380009, "order_id" => 450789469, "assigned_location_id" => 24826418, "request_status" => "submitted", "status" => "open", "fulfill_at" => nil, "fulfill_by" => nil, "supported_actions" => ["cancel_fulfillment_order"], "destination" => {"id" => 1042572139, "address1" => "Chestnut Street 92", "address2" => "", "city" => "Louisville", "company" => nil, "country" => "United States", "email" => "bob.norman@mail.example.com", "first_name" => "Bob", "last_name" => "Norman", "phone" => "+1(502)-459-2181", "province" => "Kentucky", "zip" => "40202"}, "origin" => {"address1" => nil, "address2" => nil, "city" => nil, "country_code" => "DE", "location_id" => 24826418, "name" => "Apple Api Shipwire", "phone" => nil, "province" => nil, "zip" => nil}, "line_items" => [{"id" => 1072503307, "shop_id" => 548380009, "fulfillment_order_id" => 1046000807, "quantity" => 1, "line_item_id" => 466157049, "inventory_item_id" => 39072856, "fulfillable_quantity" => 1, "variant_id" => 39072856}, {"id" => 1072503308, "shop_id" => 548380009, "fulfillment_order_id" => 1046000807, "quantity" => 1, "line_item_id" => 518995019, "inventory_item_id" => 49148385, "fulfillable_quantity" => 1, "variant_id" => 49148385}], "outgoing_requests" => [{"message" => "Fulfill this ASAP please.", "request_options" => {"notify_customer" => true}, "sent_at" => "2025-07-02T11:35:27-05:00", "kind" => "fulfillment_request"}], "international_duties" => nil, "fulfillment_holds" => [], "delivery_method" => {"id" => 989232622, "method_type" => "shipping", "min_delivery_date_time" => nil, "max_delivery_date_time" => nil, "additional_information" => {"phone" => nil, "instructions" => nil, "failed_carriers" => nil, "pickup_point_id" => nil}, "service_code" => nil, "detailed_branded_promise" => nil, "source_reference" => nil, "presented_name" => "Expedited Shipping"}}, "submitted_fulfillment_order" => {"id" => 1046000807, "created_at" => "2025-07-02T11:35:27-05:00", "updated_at" => "2025-07-02T11:35:27-05:00", "shop_id" => 548380009, "order_id" => 450789469, "assigned_location_id" => 24826418, "request_status" => "submitted", "status" => "open", "fulfill_at" => nil, "fulfill_by" => nil, "supported_actions" => ["cancel_fulfillment_order"], "destination" => {"id" => 1042572139, "address1" => "Chestnut Street 92", "address2" => "", "city" => "Louisville", "company" => nil, "country" => "United States", "email" => "bob.norman@mail.example.com", "first_name" => "Bob", "last_name" => "Norman", "phone" => "+1(502)-459-2181", "province" => "Kentucky", "zip" => "40202"}, "origin" => {"address1" => nil, "address2" => nil, "city" => nil, "country_code" => "DE", "location_id" => 24826418, "name" => "Apple Api Shipwire", "phone" => nil, "province" => nil, "zip" => nil}, "line_items" => [{"id" => 1072503307, "shop_id" => 548380009, "fulfillment_order_id" => 1046000807, "quantity" => 1, "line_item_id" => 466157049, "inventory_item_id" => 39072856, "fulfillable_quantity" => 1, "variant_id" => 39072856}, {"id" => 1072503308, "shop_id" => 548380009, "fulfillment_order_id" => 1046000807, "quantity" => 1, "line_item_id" => 518995019, "inventory_item_id" => 49148385, "fulfillable_quantity" => 1, "variant_id" => 49148385}], "outgoing_requests" => [{"message" => "Fulfill this ASAP please.", "request_options" => {"notify_customer" => true}, "sent_at" => "2025-07-02T11:35:27-05:00", "kind" => "fulfillment_request"}], "international_duties" => nil, "fulfillment_holds" => [], "delivery_method" => {"id" => 989232622, "method_type" => "shipping", "min_delivery_date_time" => nil, "max_delivery_date_time" => nil, "additional_information" => {"phone" => nil, "instructions" => nil, "failed_carriers" => nil, "pickup_point_id" => nil}, "service_code" => nil, "detailed_branded_promise" => nil, "source_reference" => nil, "presented_name" => "Expedited Shipping"}}, "unsubmitted_fulfillment_order" => {"id" => 1046000808, "created_at" => "2025-07-02T11:35:27-05:00", "updated_at" => "2025-07-02T11:35:27-05:00", "shop_id" => 548380009, "order_id" => 450789469, "assigned_location_id" => 24826418, "request_status" => "unsubmitted", "status" => "open", "fulfill_at" => nil, "fulfill_by" => nil, "supported_actions" => ["request_fulfillment", "create_fulfillment", "hold", "merge"], "destination" => {"id" => 1042572140, "address1" => "Chestnut Street 92", "address2" => "", "city" => "Louisville", "company" => nil, "country" => "United States", "email" => "bob.norman@mail.example.com", "first_name" => "Bob", "last_name" => "Norman", "phone" => "+1(502)-459-2181", "province" => "Kentucky", "zip" => "40202"}, "origin" => {"address1" => nil, "address2" => nil, "city" => nil, "country_code" => "DE", "location_id" => 24826418, "name" => "Apple Api Shipwire", "phone" => nil, "province" => nil, "zip" => nil}, "line_items" => [{"id" => 1072503309, "shop_id" => 548380009, "fulfillment_order_id" => 1046000808, "quantity" => 1, "line_item_id" => 703073504, "inventory_item_id" => 457924702, "fulfillable_quantity" => 1, "variant_id" => 457924702}], "outgoing_requests" => [], "international_duties" => nil, "fulfillment_holds" => [], "delivery_method" => {"id" => 989232623, "method_type" => "shipping", "min_delivery_date_time" => nil, "max_delivery_date_time" => nil, "additional_information" => {"phone" => nil, "instructions" => nil, "failed_carriers" => nil, "pickup_point_id" => nil}, "service_code" => nil, "detailed_branded_promise" => nil, "source_reference" => nil, "presented_name" => "Expedited Shipping"}}}), headers: {})
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2026-04/fulfillment_orders/1046000807/fulfillment_request.json")
  ...
  def test_3()
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2026-04/fulfillment_orders/1046000809/fulfillment_request/accept.json")
  ...
  def test_4()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2026-04/fulfillment_orders/1046000805/fulfillment_request/reject.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2026-04/fulfillment_orders/1046000805/fulfillment_request/reject.json")
