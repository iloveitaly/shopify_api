...
class Comment202604Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2026-04/comments.json?since_id=118373535")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2026-04/comments.json?since_id=118373535")
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2026-04/comments.json?article_id=134645308&blog_id=241253187")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2026-04/comments.json?article_id=134645308&blog_id=241253187")
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2026-04/comments.json?blog_id=241253187")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2026-04/comments.json?blog_id=241253187")
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2026-04/comments.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2026-04/comments.json")
  ...
  def test_5()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2026-04/comments/count.json?article_id=134645308&blog_id=241253187")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2026-04/comments/count.json?article_id=134645308&blog_id=241253187")
  ...
  def test_6()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2026-04/comments/count.json?blog_id=241253187")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2026-04/comments/count.json?blog_id=241253187")
  ...
  def test_7()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2026-04/comments/count.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2026-04/comments/count.json")
  ...
  def test_8()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2026-04/comments/118373535.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2026-04/comments/118373535.json")
  ...
  def test_9()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2026-04/comments/118373535.json")
      .with(
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2026-04/comments/118373535.json")
  ...
  def test_10()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2026-04/comments.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2026-04/comments.json")
  ...
  def test_11()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2026-04/comments/653537639/spam.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2026-04/comments/653537639/spam.json")
  ...
  def test_12()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2026-04/comments/653537639/not_spam.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2026-04/comments/653537639/not_spam.json")
  ...
  def test_13()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2026-04/comments/653537639/approve.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2026-04/comments/653537639/approve.json")
  ...
  def test_14()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2026-04/comments/653537639/remove.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2026-04/comments/653537639/remove.json")
  ...
  def test_15()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2026-04/comments/653537639/restore.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2026-04/comments/653537639/restore.json")
