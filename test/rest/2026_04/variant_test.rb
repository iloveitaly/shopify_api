...
class Variant202604Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2026-04/products/632910392/variants.json?since_id=49148385")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2026-04/products/632910392/variants.json?since_id=49148385")
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2026-04/products/632910392/variants.json?presentment_currencies=USD%2CCAD")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2026-04/products/632910392/variants.json?presentment_currencies=USD%2CCAD")
  ...
  def test_4()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2026-04/products/632910392/variants.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "variant" => hash_including({"option1" => "Yellow", "price" => "1.00"}) }
      )
      .to_return(status: 200, body: JSON.generate({"variant" => {"id" => 1070325042, "product_id" => 632910392, "title" => "Yellow", "price" => "1.00", "position" => 5, "inventory_policy" => "deny", "compare_at_price" => nil, "option1" => "Yellow", "option2" => nil, "option3" => nil, "created_at" => "2025-07-02T11:39:09-05:00", "updated_at" => "2025-07-02T11:39:10-05:00", "taxable" => true, "barcode" => nil, "fulfillment_service" => "manual", "grams" => 0, "inventory_management" => "shopify", "requires_shipping" => true, "sku" => nil, "weight" => 0.0, "weight_unit" => "lb", "inventory_item_id" => 1070325042, "inventory_quantity" => 0, "old_inventory_quantity" => 0, "presentment_prices" => [{"price" => {"amount" => "1.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "admin_graphql_api_id" => "gid://shopify/ProductVariant/1070325042", "image_id" => nil}}), headers: {})
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2026-04/products/632910392/variants.json")
  ...
  def test_5()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2026-04/products/632910392/variants.json")
      ...
      .to_return(status: 200, body: JSON.generate({"variant" => {"id" => 1070325039, "product_id" => 632910392, "title" => "Blue", "price" => "0.00", "position" => 5, "inventory_policy" => "deny", "compare_at_price" => nil, "option1" => "Blue", "option2" => nil, "option3" => nil, "created_at" => "2025-07-02T11:39:01-05:00", "updated_at" => "2025-07-02T11:39:01-05:00", "taxable" => true, "barcode" => nil, "fulfillment_service" => "manual", "grams" => 0, "inventory_management" => "shopify", "requires_shipping" => true, "sku" => nil, "weight" => 0.0, "weight_unit" => "lb", "inventory_item_id" => 1070325039, "inventory_quantity" => 0, "old_inventory_quantity" => 0, "presentment_prices" => [{"price" => {"amount" => "0.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "admin_graphql_api_id" => "gid://shopify/ProductVariant/1070325039", "image_id" => nil}}), headers: {})
  ...
  def test_7()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2026-04/products/632910392/variants/count.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2026-04/products/632910392/variants/count.json")
  ...
  def test_8()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2026-04/variants/808950810.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
      .to_return(status: 200, body: JSON.generate({"variant" => {"id" => 808950810, "product_id" => 632910392, "title" => "Pink", "price" => "199.00", "position" => 1, "inventory_policy" => "continue", "compare_at_price" => nil, "option1" => "Pink", "option2" => nil, "option3" => nil, "created_at" => "2025-07-02T11:38:15-05:00", "updated_at" => "2025-07-02T11:38:15-05:00", "taxable" => true, "barcode" => "1234_pink", "fulfillment_service" => "manual", "grams" => 567, "inventory_management" => "shopify", "requires_shipping" => true, "sku" => "IPOD2008PINK", "weight" => 1.25, "weight_unit" => "lb", "inventory_item_id" => 808950810, "inventory_quantity" => 10, "old_inventory_quantity" => 10, "presentment_prices" => [{"price" => {"amount" => "199.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "tax_code" => "DA040000", "admin_graphql_api_id" => "gid://shopify/ProductVariant/808950810", "image_id" => 562641783}}), headers: {})

    response = ShopifyAPI::Variant.find(
      id: 808950810,
    )

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2026-04/variants/808950810.json")
  ...
  def test_9()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2026-04/variants/808950810.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2026-04/variants/808950810.json")
  ...
  def test_10()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2026-04/variants/808950810.json")
      ...
      .to_return(status: 200, body: JSON.generate({"variant" => {"id" => 808950810, "product_id" => 632910392, "title" => "Pink", "price" => "199.00", "position" => 1, "inventory_policy" => "continue", "compare_at_price" => nil, "option1" => "Pink", "option2" => nil, "option3" => nil, "created_at" => "2025-07-02T11:38:15-05:00", "updated_at" => "2025-07-02T11:39:08-05:00", "taxable" => true, "barcode" => "1234_pink", "fulfillment_service" => "manual", "grams" => 567, "inventory_management" => "shopify", "requires_shipping" => true, "sku" => "IPOD2008PINK", "weight" => 1.25, "weight_unit" => "lb", "inventory_item_id" => 808950810, "inventory_quantity" => 10, "old_inventory_quantity" => 10, "presentment_prices" => [{"price" => {"amount" => "199.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "admin_graphql_api_id" => "gid://shopify/ProductVariant/808950810", "image_id" => 562641783}}), headers: {})
  ...
  def test_12()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2026-04/products/632910392/variants/808950810.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2026-04/products/632910392/variants/808950810.json")
