...
class InventoryLevel202604Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2026-04/inventory_levels.json?location_ids=655441491")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2026-04/inventory_levels.json?location_ids=655441491")
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2026-04/inventory_levels.json?inventory_item_ids=808950810")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2026-04/inventory_levels.json?inventory_item_ids=808950810")
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2026-04/inventory_levels.json?inventory_item_ids=808950810%2C39072856&location_ids=655441491%2C487838322")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2026-04/inventory_levels.json?inventory_item_ids=808950810%2C39072856&location_ids=655441491%2C487838322")
  ...
  def test_4()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2026-04/inventory_levels/adjust.json")
      .with(
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2026-04/inventory_levels/adjust.json")
  ...
  def test_5()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2026-04/inventory_levels.json?inventory_item_id=808950810&location_id=655441491")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2026-04/inventory_levels.json?inventory_item_id=808950810&location_id=655441491")
  ...
  def test_6()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2026-04/inventory_levels/connect.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2026-04/inventory_levels/connect.json")
  ...
  def test_7()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2026-04/inventory_levels/set.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2026-04/inventory_levels/set.json")
