...
class CancellationRequest202604Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2026-04/fulfillment_orders/1046000803/cancellation_request.json")
      .with(
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2026-04/fulfillment_orders/1046000803/cancellation_request.json")
  ...
  def test_2()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2026-04/fulfillment_orders/1046000804/cancellation_request/accept.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2026-04/fulfillment_orders/1046000804/cancellation_request/accept.json")
  ...
  def test_3()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2026-04/fulfillment_orders/1046000802/cancellation_request/reject.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2026-04/fulfillment_orders/1046000802/cancellation_request/reject.json")
