...
class Country202604Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2026-04/countries.json")
      .with(
    ...
    response = ShopifyAPI::Country.all

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2026-04/countries.json")
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2026-04/countries.json?since_id=359115488")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2026-04/countries.json?since_id=359115488")
  ...
  def test_3()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2026-04/countries.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "country" => hash_including({"code" => "FR"}) }
      )
      .to_return(status: 200, body: JSON.generate({"country" => {"id" => 980881734, "name" => "France", "code" => "FR", "tax_name" => "TVA", "tax" => 0.2, "provinces" => []}}), headers: {})

    response = country = ShopifyAPI::Country.new
    country.code = "FR"
    country.save

    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2026-04/countries.json")
  ...
  def test_4()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2026-04/countries.json")
      ...
      .to_return(status: 200, body: JSON.generate({"country" => {"id" => 980881733, "name" => "France", "code" => "FR", "tax_name" => "TVA", "tax" => 0.2, "provinces" => []}}), headers: {})
  ...
  def test_5()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2026-04/countries/count.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    response = ShopifyAPI::Country.count

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2026-04/countries/count.json")
  ...
  def test_6()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2026-04/countries/879921427.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    response = ShopifyAPI::Country.find(
      id: 879921427,
    )

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2026-04/countries/879921427.json")
  ...
  def test_7()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2026-04/countries/879921427.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "country" => hash_including({"tax" => 0.05}) }
      )
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2026-04/countries/879921427.json")
  ...
  def test_8()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2026-04/countries/879921427.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    response = ShopifyAPI::Country.delete(
      id: 879921427,
    )

    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2026-04/countries/879921427.json")
