...
class ShippingZone202604Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2026-04/shipping_zones.json")
      .with(
    ...
    response = ShopifyAPI::ShippingZone.all

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2026-04/shipping_zones.json")
